...
\t~ spare parts for your wagon\n""")
    ...
    time.sleep(2)
    print("Each round you will be able to hunt for food and ration your food.")
    time.sleep(2)
    print("Watch out for bandits. Good luck...")
    time.sleep(2)
    print()
    print()
    ...
    for rounds in range(12):
        ...
        if family_names_list == empty_list:
            ...
            print("You have no money. You have lost the game.")
            exit()
        elif main_inventory[1] <= 0:
            print("You have no more oxen to pull your wagon. "
...
Returns:
    list that will be assigned to a value for inventory
    """
    oxen = 1
    food = 2
    clothing = 3
...
Returns:
    local_inventory: updated inventory list
    """
    food = 2
    ammunition = 4
...
Parameters:
    ...
    print("Oxen: {0} Food: {1} lbs Clothing: {2} Ammunition: {3} "
          "Spare Parts: {4}"
